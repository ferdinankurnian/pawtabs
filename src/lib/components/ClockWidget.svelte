<script>
    ...
    function drawTicks() {
        ...
        const tickColor =
            variant === "dark" ? "rgba(161,161,170,.85)" : "rgba(82,82,91,.85)";
        const minorTickColor =
            variant === "dark" ? "rgba(82,82,91,.75)" : "rgba(161,161,170,.65)";
        const numberColor =
            variant === "dark" ? "rgba(161,161,170,.85)" : "rgba(63,63,70,.85)";
...
<div class="clock-cell">
    <div class="analog-wrap">
        <div class="face" class:light={variant === "light"}>
            <canvas bind:this={canvas} width="120" height="120" class="ticks"
            ></canvas>
            <div
                class="hand hour"
